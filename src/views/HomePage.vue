    ...
    <div>
        <div class="position-relative">
            ...
            <section class="section section-shaped my-0 overflow-hidden">
                <div class="shape shape-style-3 shape-gogo1 shape-skew">
                    <span></span>
                    <span></span>
                    <span></span>
                    <span></span>
                ...
                <div class="container shape-container d-flex ">
                    <div class="row text-center justify-content-center mt--200">
                        <div class="col-lg-8 slide-to-left">
                            <transition name="fade">
                                    <img src="../img/gogopic.png" class="img-fluid floating" v-on:load="onLoaded" v-show="loaded"/>
                            </transition>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row text-center justify-content-center mt--200">
                        <div class="col-lg-8">
                            <card gradient="secondary" shadow body-classes="p-lg-5">
                                <h1 class="display-1 text-black">GoGo Board</h1>
                                <h2 class="display-2 text-muted"><span>Turn imagination to practice.</span></h2>
            ...
            <section class="section-shaped my-0">
                ...
                <div class="container shape-container d-flex">
                    <div class="col px-0">
                        <div class="row">
                            <div class="col-lg-6">
                                <h1 class="display-1  text-white">TRY THIS</h1>
        ...
        <section class="section section-lg pt-lg-0 ">
            <div class="container">
                <div class="row justify-content-center">
                    <h1 class="display-1 mt--100">Supported Platform</h1>
                    <div class="col-lg-13 ">
                        <div class="row row-grid ">
                            <div class="col-lg-4">
                                <card class="border-0 h-100" hover shadow body-classes="py-5">
                                    <!-- <img src="../img/arduino-logo.png" class="img-fluid floating img-logo"> -->
                            ...
                            <div class="col-lg-4">
                                <card class="border-0 h-100" hover shadow body-classes="py-5">
                                    <!-- <img src="../img/groove-logo.png" class="img-fluid floating img-logo"> -->
                                    <h6 class="text-success text-uppercase">Grove Sensor</h6>
                                    <p class="description mt-3">Grove is an open modular system designed for easy connection of any input or output model to a microprocessor. 
                                        Grove sensors are provided in the category of Robotics, Proximity, Motion, Environmental, and Biomedical.</p>
                                    <div>
                            ...
                            <div class="col-lg-4">
                                <card class="border-0 h-100" hover shadow body-classes="py-5">
                                    ...
                                    <p class="description mt-3">Scratch is a free programming language and online community where you can create your own interactive stories, 
        ...
        <section class="section-shaped my-0">
                ...
                <div class="container">
                    <div class="row row-grid justify-content-center">
                        <div class="col-lg-8 text-center">
                            <h1 class="display-1 text-dark">GoGo Code
                            </h1>
            ...
            <!-- <div class="container">
                <div class="row justify-content-center">
                    <h1 class="display-1 mt--100">Code.GoGo</h1>
                    <div class="col-lg-12">
                        <div class="card shadow bg-gradient-secondary">
                            <div class="card-body p-lg-5">
                                <web :src="'https://code.gogoboard.org/#/'"/>
